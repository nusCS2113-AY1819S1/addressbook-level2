...
Shows a list of all persons, in alphabetical order, along with their non-private details, in the address book. +
Format: `sort`
...
[NOTE]
====
The search is case ininsensitive, the order of the keywords does not matter, only the name is searched,
