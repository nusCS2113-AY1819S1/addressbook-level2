...
Once a new person is added, all the people in the address book are listed.
...
Once a person at the specified index is deleted, the remaining people in the address book are listed.
