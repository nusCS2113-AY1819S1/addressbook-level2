...
* Sort the current AddressBook list in alphabetical order by taking the names of all contacts
...
== Sorting the current list of persons : `sort`

Sorts the current list alphabetically by names of persons. +
Format: `sort`
