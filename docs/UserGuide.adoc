...
== Edit a particular person from the addressbook: 'edit'
Edit a person's email, phone number and/or tag(s).
...
* `edit John Doe p/98765432 e/johnd@hotmail.com a/John street, block 456, #01-01`
* `edit Betsy Crowe pp/1234567 e/betsycrowe@hotmail.com pa/Newgate Prison t/criminal t/friend`
