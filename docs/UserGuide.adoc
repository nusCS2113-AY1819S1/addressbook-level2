...
* View list of people in addressbook in an alphabetical order (`sort`: shows an alphabetically arranged list of people in addressbook) 
...
Shows a list of all persons, along with their non-private details, in the address book  in alphabetical order. +
Format: `sort`
...
Address book data are saved in the hard disk automatically after any command that changes the data except for sort command.
