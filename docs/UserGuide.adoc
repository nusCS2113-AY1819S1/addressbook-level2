...
* Support for listing persons by name in alphabetical order
...
== Listing all persons by name in alphabetical order: `sorted`

Shows a list of all persons, sorted by name in alphabetical order, along with their non-private details, in the address book. +
Format: `sorted`
