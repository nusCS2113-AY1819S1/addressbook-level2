...
Adds a person to the address book and prints a list after the person has been added. +
...
****
Deletes the person at the specified `INDEX` and prints a list after the person has been deleted.
