...
* View the list of persons immediately after adding a new person and deleting an existing person
...
Lists all the existing persons, along with their non-private details, in the address book. +
Format: `list`
...
Lists all existing persons, along with their non-private details, in the address book. +
Format: `list`
