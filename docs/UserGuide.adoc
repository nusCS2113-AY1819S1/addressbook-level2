...
* Support for marking a contact detail as 'private' (`pa/`) (`pe/`) (`pp/`) (`pg/`)
...
Format: `add NAME [p]p/PHONE_NUMBER [p]e/EMAIL [p]a/ADDRESS [p]g/GENDER [t/TAG]...`
...
* `add John Doe p/98765432 e/johnd@gmail.com a/John street, block 123, #01-01 g/M`
* `add Betsy Crowe pp/1234567 e/betsycrowe@gmail.com pa/Newgate Prison g/F t/criminal t/friend`
