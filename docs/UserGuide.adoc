...
* Sorts the entire list alphabetically by the first name of all contacts
...
== Sorting the entire list : `sort`

Sorts all of the contacts in the current addressbook alphabetically by the first name. +
Format: `sort`
