...
* Support for access to AddressBook using login credentials
...
As for login credentials, the file containing the login data must end in `.PROPERTIES` for it to be acceptable to the program.
