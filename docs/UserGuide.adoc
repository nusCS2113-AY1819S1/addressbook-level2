...
* Support for sorting and listing the contacts in ascending alphabetical order  
...
== Sorting contacts in address book and listing all persons : 'sort'

Shows a list of all persons sorted in ascending alphabetical order, alongside their non-private details, in the address book.
Format: 'sort'
