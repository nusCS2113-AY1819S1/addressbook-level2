...
Shows a list of all persons, along with their non-private details, in the address book after adding the new person.
...
Shows a list of all persons, along with their non-private details, in the address book after deleting the person.
****
