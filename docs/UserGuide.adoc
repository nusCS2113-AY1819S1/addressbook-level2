...
== Sort AddressBooklevel(2) elements by Name: `sortName`
Sort the elements in addressBookLevel(2) by Name and print the sorted list by names along with their details.
Format: `sortName`
