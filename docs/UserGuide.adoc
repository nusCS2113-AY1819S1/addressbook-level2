...
Adds a person to the address book, then lists the details of the people in the address book, including those of the person just added. +
...
****
Deletes the person at the specified `INDEX`, then lists the people left in the list.
...
`delete 2` +
`list` +
Deletes the 2nd person in the address book, then lists the details of the people still in the address book.

* `find Betsy` +
`delete 1` +
`list` +
Deletes the 1st person in the results of the `find` command, then lists the details of the people still in the address book.
