...
public class EditCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Edits a person identified by the index number " +
            "used in the last person listing. details in the address book.\n"
    ...
    public CommandResult execute() {
        try {
            ...
            return new CommandResult(String.format(getMessageEditPersonSuccess(), target));
